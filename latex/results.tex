...
The first thing to note from the tests is the large variabtion between the shapes of the mass flow rate even within tests of the same inlet pressure. Comparing the mass flow rate for all tests with a 4 bar pressure inlet shows this phenomenon. Important to note is due to the smoothing applied, done by taking the average of a 100 sample window that moves through the system, there is edge distortion at the start and end. The sensors were polled at a frequency of 10Hz meaning that 10s of 
