...
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.3\textwidth}
        ...
        \caption{Current feed system diagram.}\label{fig:static-pressure-drop-3bar}
    \end{minipage}
    \hfill
    \begin{minipage}{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../report_assets/Fluidized_Bed_polished.png}
        \caption{Simplified fluidized powder bed diagram.}\label{fig:static-pressure-drop-4bar}
    \end{minipage}
    \hfill
    \begin{minipage}{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../report_assets/configuration_that_demands_pms.png}
        \caption{Fluent simulation in microgravity.}\label{fig:static-pressure-drop-5bar}
    \end{minipage}
