...
# Read the CSV files
input_file_1 = 'Research_Files/May/filter_test/after_kermit106.csv'  # 0 2 7
input_file_2 = 'Research_Files/May/filter_test/after_kermit108.csv'  # 0 1 7
...
plt.axhline(y=1.203, color='orange', linestyle='-.', label='y = 1.205')
