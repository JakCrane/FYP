...
# Read the CSV files
input_file_1 = 'Research_Files/June/6_bar_sand/3_kermit106.csv'  # 0 2 7
input_file_2 = 'Research_Files/June/6_bar_sand/3_kermit108.csv'  # 0 1 7
...
df_1['BackendTime'] = (df_1['BackendTime'] - 1749749978230) / 1e3 - 150 
df_2['BackendTime'] = (df_2['BackendTime'] - 1749749978230) / 1e3 - 150
...
df_1 = df_1[(df_1['BackendTime'] >= 10) & (df_1['BackendTime'] <= 50)]
df_2 = df_2[(df_2['BackendTime'] >= 10) & (df_2['BackendTime'] <= 50)]
...
plt.axvline(x=15.7, color='green', linestyle='--')
plt.axvline(x=42.6, color='green', linestyle='--')
...
# plt.show()
# # Save the plot
plt.savefig('./latex/report_assets/63_raw_mass.png')
...
# # Read the CSV files
# input_file_1 = 'Research_Files/June/6_bar_sand/3_kermit106_clean.csv'  # 0 2 7
# input_file_2 = 'Research_Files/June/6_bar_sand/3_kermit108_clean.csv'  # 0 1 7
...
# # plt.show()
# # # Show the plot
# plt.savefig('./latex/report_assets/63_clean_mass.png')
...
# plt.axvline(x=31.4, color='red', linestyle='--')
# plt.axvline(x=42.6, color='green', linestyle='--')
...
# # # Show the plot
# plt.savefig('./latex/report_assets/63_clean_flow_50.png')
