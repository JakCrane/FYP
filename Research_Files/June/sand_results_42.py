...
# # Read the CSV files
# input_file_1 = 'Research_Files/May/4_bar_sand/23_kermit106.csv'  # 0 2 7
# input_file_2 = 'Research_Files/May/4_bar_sand/23_kermit108.csv'  # 0 1 7
...
# df_1['BackendTime'] = (df_1['BackendTime'] - 1748801185550) / 1e3
# df_2['BackendTime'] = (df_2['BackendTime'] - 1748801185550) / 1e3
...
# df_1 = df_1[(df_1['BackendTime'] >= 17) & (df_1['BackendTime'] <= 85)]
# df_2 = df_2[(df_2['BackendTime'] >= 17) & (df_2['BackendTime'] <= 85)]
...
# plt.axvline(x=26.1, color='green', linestyle='--')
# plt.axvline(x=76.3, color='green', linestyle='--')
...
# plt.ylim(-0.2, 2.5)
# # Show the plot
# plt.savefig('./latex/report_assets/42_raw_mass.png')
...
# input_file_1 = 'Research_Files/May/4_bar_sand/23_kermit106_clean.csv'  # 0 2 7
# input_file_2 = 'Research_Files/May/4_bar_sand/23_kermit108_clean.csv'  # 0 1 7
...
# # # Show the plot
# # plt.show()
# plt.savefig('./latex/report_assets/42_clean_mass.png')
...
plt.axvline(x=26.1, color='green', linestyle='--')
plt.axvline(x=36.1, color='red', linestyle='--')
plt.axvline(x=57.0, color='red', linestyle='--')
plt.axvline(x=76.3, color='green', linestyle='--')
...
# # Show the plot
# plt.show()
plt.savefig('./latex/report_assets/42_clean_flow_100.png')
