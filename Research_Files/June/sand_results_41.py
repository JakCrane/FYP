...
# Read the CSV files
input_file_1 = 'Research_Files/May/4_bar_sand/22_kermit106.csv'  # 0 2 7
input_file_2 = 'Research_Files/May/4_bar_sand/22_kermit108.csv'  # 0 1 7
...
df_1['BackendTime'] = (df_1['BackendTime'] - 1748791982690) / 1e3
df_2['BackendTime'] = (df_2['BackendTime'] - 1748791982690) / 1e3
...
df_1 = df_1[df_1['BackendTime'] >= 8]
df_2 = df_2[df_2['BackendTime'] >= 8]
...
plt.axvline(x=15.6, color='green', linestyle='--')
plt.axvline(x=77.1, color='green', linestyle='--')
...
# Show the plot
# plt.show()
plt.savefig('./latex/report_assets/41_raw_mass.png')
...
# # Read the CSV files
# input_file_1 = 'Research_Files/May/4_bar_sand/22_kermit106_clean.csv'  # 0 2 7
# input_file_2 = 'Research_Files/May/4_bar_sand/22_kermit108_clean.csv'  # 0 1 7
...
# # # Show the plot
# # plt.show()
# plt.savefig('./latex/report_assets/41_clean_mass.png')
...
# plt.axvline(x=15.6, color='green', linestyle='--')
# plt.axvline(x=25.6, color='red', linestyle='--')
# plt.axvline(x=53.3, color='red', linestyle='--')
...
# plt.legend()
# plt.tight_layout()
# plt.savefig('./latex/report_assets/41_clean_flow_100.png')
