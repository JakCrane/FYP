...
# # Read the CSV files
# input_file_1 = 'Research_Files/June/6_bar_sand/1_kermit106.csv'  # 0 2 7
# input_file_2 = 'Research_Files/June/6_bar_sand/1_kermit108.csv'  # 0 1 7
...
# df_1['BackendTime'] = (df_1['BackendTime'] - 1749660249129) / 1e3
# df_2['BackendTime'] = (df_2['BackendTime'] - 1749660249129) / 1e3
...
# df_1 = df_1[(df_1['BackendTime'] >= 292) & (df_1['BackendTime'] <= 326)]
# df_2 = df_2[(df_2['BackendTime'] >= 292) & (df_2['BackendTime'] <= 326)]
...
# plt.axvline(x=297.6, color='green', linestyle='--')
# plt.axvline(x=320.3, color='green', linestyle='--')
...
# plt.tight_layout()
# # Show the plot
# plt.savefig('./latex/report_assets/61_raw_mass.png')
...
# # Read the CSV files
# input_file_1 = 'Research_Files/June/6_bar_sand/1_kermit106_clean.csv'  # 0 2 7
# input_file_2 = 'Research_Files/June/6_bar_sand/1_kermit108_clean.csv'  # 0 1 7
...
# plt.tight_layout()
# # # Show the plot
# plt.savefig('./latex/report_assets/61_clean_mass.png')
# plt.show()
...
window_size = 50  # Adjust as needed for smoothing
...
plt.axvline(x=297.6, color='green', linestyle='--')
plt.axvline(x=303.6, color='red', linestyle='--')
plt.axvline(x=312.5, color='red', linestyle='--')
plt.axvline(x=320.3, color='green', linestyle='--')
...
plt.tight_layout()
# # Show the plot
plt.savefig('./latex/report_assets/61_clean_flow_50.png')
