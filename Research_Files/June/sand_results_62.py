...
# # Read the CSV files
# input_file_1 = 'Research_Files/June/6_bar_sand/2_kermit106.csv'  # 0 2 7
# input_file_2 = 'Research_Files/June/6_bar_sand/2_kermit108.csv'  # 0 1 7
...
# df_1['BackendTime'] = (df_1['BackendTime'] - 1749746362950) / 1e3 - 540
# df_2['BackendTime'] = (df_2['BackendTime'] - 1749746362950) / 1e3 - 540
...
# df_1 = df_1[(df_1['BackendTime'] >= 18) & (df_1['BackendTime'] <= 50)]
# df_2 = df_2[(df_2['BackendTime'] >= 18) & (df_2['BackendTime'] <= 50)]
...
# plt.axvline(x=22.3, color='green', linestyle='--')
# plt.axvline(x=46.9, color='green', linestyle='--')
...
# # plt.show()
# # # Save the plot
# plt.savefig('./latex/report_assets/62_raw_mass.png')
...
# # Read the CSV files
# input_file_1 = 'Research_Files/June/6_bar_sand/2_kermit106_clean.csv'  # 0 2 7
# input_file_2 = 'Research_Files/June/6_bar_sand/2_kermit108_clean.csv'  # 0 1 7
...
# # # Show the plot
# plt.savefig('./latex/report_assets/62_clean_mass.png')
...
# # Show the plot
plt.savefig('./latex/report_assets/62_clean_flow_100.png')
