...
# Read the CSV files
input_file_1 = 'Research_Files/June/5_bar_sand/1_kermit106.csv'  # 0 2 7
input_file_2 = 'Research_Files/June/5_bar_sand/1_kermit108.csv'  # 0 1 7
...
df_1['BackendTime'] = (df_1['BackendTime'] - 1748806421850) / 1e3
df_2['BackendTime'] = (df_2['BackendTime'] - 1748806421850) / 1e3
