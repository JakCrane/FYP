...
# df_1 = df_1[(df_1['BackendTime'] >= 86) & (df_1['BackendTime'] <= 133)]
# df_2 = df_2[(df_2['BackendTime'] >= 86) & (df_2['BackendTime'] <= 133)]
...
# # Read the CSV files
# input_file_1 = 'Research_Files/June/5_bar_sand/1_kermit106_clean.csv'  # 0 2 7
# input_file_2 = 'Research_Files/June/5_bar_sand/1_kermit108_clean.csv'  # 0 1 7
