...
# # Read the CSV files
# input_file_1 = 'Research_Files/May/4_bar_sand/24_kermit106.csv'  # 0 2 7
# input_file_2 = 'Research_Files/May/4_bar_sand/24_kermit108.csv'  # 0 1 7
...
# df_1['BackendTime'] = (df_1['BackendTime'] - 1748804282220) / 1e3
# df_2['BackendTime'] = (df_2['BackendTime'] - 1748804282220) / 1e3
...
# df_1 = df_1[(df_1['BackendTime'] >= 55) & (df_1['BackendTime'] <= 115)]
# df_2 = df_2[(df_2['BackendTime'] >= 55) & (df_2['BackendTime'] <= 115)]
...
# plt.axvline(x=62.9, color='green', linestyle='--')
# plt.axvline(x=107.1, color='green', linestyle='--')
...
# # Show the plot
# # plt.show()
# plt.savefig('./latex/report_assets/43_raw_mass.png')
...
# # Read the CSV files
# input_file_1 = 'Research_Files/May/4_bar_sand/24_kermit106_clean.csv'  # 0 2 7
# input_file_2 = 'Research_Files/May/4_bar_sand/24_kermit108_clean.csv'  # 0 1 7
...
# # # Show the plot
# # plt.show()
# plt.savefig('./latex/report_assets/43_clean_mass.png')
...
plt.axvline(x=62.9, color='green', linestyle='--')
plt.axvline(x=72.9, color='red', linestyle='--')
plt.axvline(x=89.2, color='red', linestyle='--')
plt.axvline(x=107.1, color='green', linestyle='--')
...
plt.tight_layout()
# # Show the plot
plt.savefig('./latex/report_assets/43_clean_flow_100.png')
