...
# df_1 = df_1[(df_1['BackendTime'] >= 19) & (df_1['BackendTime'] <= 62)]
# df_2 = df_2[(df_2['BackendTime'] >= 19) & (df_2['BackendTime'] <= 62)]
...
# plt.axvline(x=24.8, color='green', linestyle='--')
...
# # plt.show()
# # # Save the plot
# plt.savefig('./latex/report_assets/64_raw_mass.png')
...
# # Read the CSV files
# input_file_1 = 'Research_Files/June/6_bar_sand/4_kermit106_clean.csv'  # 0 2 7
# input_file_2 = 'Research_Files/June/6_bar_sand/4_kermit108_clean.csv'  # 0 1 7
...
# # # Show the plot
# plt.savefig('./latex/report_assets/64_clean_mass.png')
...
plt.ylabel('Load Cell Values (kg)')
plt.legend()
plt.ylim(-0.001, 0.0068)

# # Show the plot
plt.savefig('./latex/report_assets/64_clean_flow_100.png')
