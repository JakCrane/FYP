...
# Read the CSV files
input_file_1 = 'Research_Files/June/6_bar_sand/4_kermit106.csv'  # 0 2 7
input_file_2 = 'Research_Files/June/6_bar_sand/4_kermit108.csv'  # 0 1 7
...
df_1['BackendTime'] = (df_1['BackendTime'] - 1749753161060) / 1e3 
df_2['BackendTime'] = (df_2['BackendTime'] - 1749753161060) / 1e3
